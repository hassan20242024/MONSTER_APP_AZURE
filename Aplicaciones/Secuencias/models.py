...
class Lavado_buzo(models.Model):
    ...
    #progrmado = datetime.datetime.now() + datetime.timedelta(days=30) 
    #limite_inferior = datetime.datetime.now() + datetime.timedelta(days=59.8) 
    #limite_superior = datetime.datetime.now() + datetime.timedelta(days=60.9) 
    #progrmado_mantenimiento = datetime.datetime.now() + datetime.timedelta(days=60.8) 
    #limite_inferior_mantenimiento = datetime.datetime.now() + datetime.timedelta(days=5) 
    #limite_superior_mantenimiento = datetime.datetime.now() + datetime.timedelta(days=7) 
    #progrmado_calificacion = datetime.datetime.now() + datetime.timedelta(days=60.8)
    #limite_inferior_calificacion = datetime.datetime.now() + datetime.timedelta(days=5)
    #limite_superior_calificacion = datetime.datetime.now() + datetime.timedelta(days=7)
    sistema=models.ForeignKey(to=Sistema, on_delete=models.CASCADE, verbose_name="Sistema", null=True, blank=False)
